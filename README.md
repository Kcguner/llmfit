...
> 🎨 **Desktop UI/UX Remastered by [YourGitHubUsername](https://github.com/YourGitHubUsername)**

The easiest way to use **llmfit** is by downloading the standalone Desktop Application. It features a beautiful, zero-config industrial dark theme and requires no terminal knowledge.

1. Go to the **[Releases](https://github.com/AlexsJones/llmfit/releases)** page.
...
3. Run the installer to enjoy the desktop experience.

---

### 💻 Command Line (CLI / TUI)

If you prefer the terminal interface or want to use llmfit in your scripts, install the CLI version:
